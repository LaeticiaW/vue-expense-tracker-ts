...
describe('ExpenseDialog.vue', () => {
    ...
    test('Pressing the Save button saves the expense and emits the expense-updated event', async () => {
        const saveSpy = jest.spyOn(ExpenseService, 'saveExpense')
        ...
        expect(wrapper.emitted()['expense-updated'][0][0]).toEqual(expect.objectContaining({
            _id: 503,
            trxDate: '2020-05-01',
            trxYear: 2020,
            trxMonth: 2,
