...
describe('Imports.vue', () => {
    ...
    const imports = [
        { _id: '1', importDate: '2020-04-17', fileName: 'Visa1-01_01_2020_to_04_05_2020.CSV', description: 'mycreditcard1', recordCount: 30, __v: 0 },
        { _id: '2', importDate: '2020-04-17', fileName: 'Visa2-Jan1-Apr7.csv', description: 'mycreditcard2', recordCount: 164, __v: 0 }
    ]
    ...
    test('Renders page title, filter, and data table', async () => {
        ...
        // Test values
        expect(pageTitle).toEqual('Imports')
