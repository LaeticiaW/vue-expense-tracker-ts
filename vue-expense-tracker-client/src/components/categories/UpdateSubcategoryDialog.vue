...
<script lang="ts">
    ...
    import { Category, Subcategory, Rule } from '@/types/index'
    ...
    export default Vue.extend({
        ...
        data() {
            return {
                ...
                selectedMatchText: '' as string,
                nameRules: [] as Rule[],                
                newMatchText: '' as string,
                tempCategory: _.cloneDeep(this.category) as Category,
                tempSubcategory: _.cloneDeep(this.subcategory) as Subcategory              
            }
        },
        ...
        methods: {
            ...
            isSubcategoryUnique() : boolean {                
                ...
                const idx = this.tempCategory.subcategories.findIndex(subcat => {                    
                    return  subcat.name.toLowerCase() === this.tempSubcategory.name.toLowerCase() &&
                            subcat.id !== this.tempSubcategory.id                 
             ...
             */
            deleteMatchText(text: string, idx: number) : void {
                this.dialogMessage = ''
                if (this.tempSubcategory.matchText && this.tempSubcategory.matchText.length) {
         ...
         */
        created() : void {           
            // Set validation rules for name input
            this.nameRules = [
